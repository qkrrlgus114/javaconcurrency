...
public class AsyncExecutorExample {
    public static void main(String[] args) {
        ...
        asyncExecutor.execute(()->{
            ...
            // 작업 수행
            System.out.println("비동기 작업 3 완료...");
        });

        asyncExecutor.execute(()->{
            System.out.println("비동기 작업 4 수행 중...");
            // 작업 수행
            System.out.println("비동기 작업 4 완료...");
        });

        asyncExecutor.execute(()->{
            System.out.println("비동기 작업 5 수행 중...");
            // 작업 수행
            System.out.println("비동기 작업 5 완료...");
        });
    }
